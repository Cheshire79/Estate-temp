...
namespace WebUI.Controllers
{
    public class UserController : Controller
    {
        ...
        public UserController(IUserService managerService, IMapperFactoryWEB mapperFactory)
        {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            specifyingSkillsViewModel.SpecifyingSkills =
                   await (from skill in _userService.Skills().ProjectTo<SkillViewModel>(_mapper.ConfigurationProvider)
        ...
        private IQueryable<SpecifyingSubSkillViewModel> GetSpecifyingSubSkillsForUser(string iserId, int minLevelId)
        {
            var formForSpecifyingSubSkills =
                (from subSkill in _userService.SubSkills().ProjectTo<SubSkillViewModel>(_mapper.ConfigurationProvider)
