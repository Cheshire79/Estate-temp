...
namespace WebUI.Controllers
{
    public class SearchForUsersController : Controller
    {
        ...
        public SearchForUsersController(IUserService userService,
        ...
        public async Task<ActionResult> Index()
        {
            ...
            specifyingSkillsViewModel.SpecifyingSkills =
                from s in _userService.Skills().ProjectTo<SkillViewModel>(_mapper.ConfigurationProvider)
                join sk in _userService.SubSkills().ProjectTo<SubSkillViewModel>(_mapper.ConfigurationProvider)
        ...
        public async Task<ActionResult> Index(List<SpecifyingSkillForSearchSaveModel> specifyingSkillsForSearchSaveModel, UsersSearchResult usersSearchResult)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                usersSearchResultViewModel.UserSearchListResultViewModel = (from u in Users
        ...
        {
            var specifyingSkills = (from s in _userService.Skills().ProjectTo<SkillViewModel>(_mapper.ConfigurationProvider)
                                    join osk in
                                        (from sk in _userService.SubSkills().ProjectTo<SubSkillViewModel>(_mapper.ConfigurationProvider)
