...
namespace KnowledgeManagement.BLL.Services
{
    public class UserService : IUserService
    {
        ...
        public IQueryable<SkillDTO> Skills()
        {
        ...
        public IQueryable<SubSkillDTO> SubSkills(int skillId)
        {
        ...
        public IQueryable<SubSkillDTO> SubSkills()
        {
        ...
        public async Task SaveSpecifyingSkill(List<SpecifyingSkillDTO> list, string userId)
        {
            ...
            foreach (var item in list)
            {
                if ((await _unitOfWork.Levels.GetByIdAsync(item.LevelId)).Order > min) // save into base only if skill higher then first 
                    ...
                    _unitOfWork.SpecifyingSkills.Create(new DAL.Interface.Date.SpecifyingSkill()
                    {
